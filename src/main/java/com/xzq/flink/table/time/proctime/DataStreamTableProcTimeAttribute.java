 ...
 *
 */
public class DataStreamTableProcTimeAttribute {
	...
	public static void main(String[] args) throws Exception {
		...
		tableEnv.registerDataStream("table-time-attr", env.fromCollection(list), "catg, cnt, ts, price, DateProcTime.proctime");
